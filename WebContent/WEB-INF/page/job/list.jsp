  ...
  <body>
    <div class="x-nav">
      <span class="layui-breadcrumb">
        ...
        <button type="button" onclick="location.href='${ctx}/job/add'" class="layui-btn layui-btn-small" style="line-height:1.6em;margin-top:3px;float:innert;margin-left:75%;;"  ><i class="layui-icon"></i>增加</button>
