...
<div class="x-nav">
    ...
    <c:choose>
        <c:when test="${sessionScope.tip  == 1 }">
            <button type="button" onclick="x_admin_show('增加','${ctx}/job/add')" class="layui-btn layui-btn-small"
...
<div class="x-body">
    <div class="layui-row" style="" align="center">
        <form class="layui-form layui-col-md12 x-so" method="get" action="${ctx }/job/list">
            ...
            <a class="layui-btn layui-btn-small" style="line-height:1.6em;margin-top:0px;" href="${ctx }/job/list"
               title="刷新">
