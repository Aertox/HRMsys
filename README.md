## 写在前面
本项目同样是基于github中的一个项目修改而来（(https://github.com/rainweb521/Personnel-Management-System)），本人对于其中的业务关系并没有做太大的完善，仍然存在一些业务逻辑的不完整，但是把项目配置好是可以跑起来的，应付课程设计基本没问题，部署有问题可以尝试联系我 (2063617362@qq.com)
